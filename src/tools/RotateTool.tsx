        ...
        <div className="space-y-6">
          ...
          <div className="pt-2">
            <button
              ...
              className="w-full inline-flex items-center justify-center gap-2 rounded-2xl btn-gradient-purple btn-shimmer px-6 py-4.5 text-base font-bold text-white shadow-lg shadow-violet-600/25 active:scale-[0.99] transition-all disabled:opacity-50 min-h-[56px] cursor-pointer"
