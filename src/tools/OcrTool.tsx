        ...
        <div className="space-y-6">
          ...
          <div className="pt-2">
            <button
              ...
              className="w-full inline-flex items-center justify-center gap-2 rounded-2xl bg-purple-600 px-6 py-4 text-base font-bold text-white shadow-lg shadow-purple-600/20 hover:bg-purple-700 active:scale-[0.99] transition-all disabled:opacity-50 min-h-[52px]"
              id="start-ocr-button"
            >
              {processing ? (
                <>
